...
const Message: React.FC<MessageProps> = ({ profileImage, message, revers }) => {
  ...
  return (
    <div className={`flex ${revers ? '' : 'flex-row-reverse'} gap-x-2 items-center justify-center px-2`}>
    <Image
      width={200}
      height={200}
        ...
        />
    <div className={`flex items-start ${revers ? 'bg-blue-600 text-white' : ''} font-bold p-2 w-full space-x-4 bg-white shadow rounded-lg`}>
...
export const Chat = ()=> {
  ...
  return(<div className="fixed flex items-center justify-center rounded-full p-2 bg-blue-500 w-14 h-14 right-20 bottom-8 z-[1000]">
          ...
          <div className="flex justify-between py-1 px-2">
            ...
            <div ref={chatRef} className="hover:overflow-y-auto border-t border-gray-300 overflow-y-hidden py-2 space-y-2 h-full">
